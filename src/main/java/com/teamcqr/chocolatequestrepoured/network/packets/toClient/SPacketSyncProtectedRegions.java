...
public class SPacketSyncProtectedRegions implements IMessage {
	...
	private final List<CompoundNBT> protectedRegions = new ArrayList<>();
	...
	public void toBytes(ByteBuf buf) {
		...
		for (CompoundNBT compound : this.protectedRegions) {
			ByteBufUtils.writeTag(buf, compound);
		}
	}

	public List<CompoundNBT> getProtectedRegions() {
