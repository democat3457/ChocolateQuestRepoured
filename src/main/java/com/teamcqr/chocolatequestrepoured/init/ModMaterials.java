...
public class ModMaterials {
	...
	public static class ArmorMaterials {
		...
		public static final ArmorMaterial ARMOR_HEAVY_DIAMOND = createArmorMaterial("heavy_diamond", 82, new int[] { 4, 7, 9, 4 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 4.0F);
		public static final ArmorMaterial ARMOR_HEAVY_IRON = createArmorMaterial("heavy_iron", 74, new int[] { 3, 6, 8, 3 }, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
		...
		public static final ArmorMaterial ARMOR_CROWN = createArmorMaterial("king_crown", 10, new int[] { 4,7,9,4}, 20, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.5F);
