...
public class ProjectileHookShotHook extends ProjectileBase {
	...
	public ProjectileHookShotHook(World worldIn, LivingEntity shooter, ItemHookshotBase hookshot, ItemStack stack) {
		super(worldIn, shooter);
		this.dataManager.set(SHOOTER_UUID, Optional.of(shooter.getUniqueID())); //only need to set this once
