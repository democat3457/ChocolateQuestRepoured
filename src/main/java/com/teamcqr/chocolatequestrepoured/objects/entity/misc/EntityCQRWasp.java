...
public class EntityCQRWasp extends EntityCreature implements net.minecraft.entity.passive.EntityFlying {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(0, new EntityAINearestAttackableTarget<>(this, LivingEntity.class, 100, true, true, new Predicate<LivingEntity>() {

			@Override
			public boolean apply(LivingEntity input) {
				return (input instanceof PlayerEntity || input.getCreatureAttribute() == EnumCreatureAttribute.ILLAGER  || input.getCreatureAttribute() == EnumCreatureAttribute.UNDEAD);
			}
		}));
	}
