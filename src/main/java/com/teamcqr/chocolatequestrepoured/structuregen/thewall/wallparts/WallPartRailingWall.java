	...
	private void placeSpawner(BlockPos spawnerPos, World world, Map<BlockPos, ExtendedBlockState> stateMap) {
		...
		if (spawnerEnt instanceof LivingEntity) {
			...
			case 0:
				...
				break;
			case 1:
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.DIAMOND_AXE, 1));
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(ModItems.SHIELD_SPECTER, 1));
				break;
			case 2:
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.BOW, 1));
				break;
			case 3:
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.BOW, 1));
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(ModItems.SHIELD_SPECTER, 1));
			...
			case 4:
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.DIAMOND_SWORD, 1));
				spawnerEnt.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Items.DIAMOND_SWORD, 1));
				break;
			}
			...
			spawnerEnt.setItemStackToSlot(EquipmentSlotType.HEAD, helmet);
			...
			spawnerEnt.setItemStackToSlot(EquipmentSlotType.CHEST, chest);
			...
			spawnerEnt.setItemStackToSlot(EquipmentSlotType.LEGS, legs);
			...
			stateMap.put(spawnerPos, new ExtendedBlockStatePart.ExtendedBlockState(state2, tileSpawner.writeToNBT(new CompoundNBT())));
		}
	}
