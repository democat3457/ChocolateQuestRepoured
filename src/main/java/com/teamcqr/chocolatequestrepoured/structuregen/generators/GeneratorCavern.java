...
public class GeneratorCavern extends AbstractDungeonGenerator<DungeonCavern> {
	...
	public void preProcess() {
		...
		this.customGenerator.add(new DungeonPartBlock(world, customGenerator, pos, blockInfoList, new PlacementSettings(), EDungeonMobType.ZOMBIE));
	}
	...
	public void fillChests() {
		...
		this.customGenerator.add(new DungeonPartBlock(world, customGenerator, start, list, new PlacementSettings(), EDungeonMobType.ZOMBIE));
	}
	...
	public void placeSpawners() {
		...
		this.customGenerator.add(new DungeonPartBlock(world, customGenerator, spawnerPos, list, new PlacementSettings(), EDungeonMobType.ZOMBIE));
	}
