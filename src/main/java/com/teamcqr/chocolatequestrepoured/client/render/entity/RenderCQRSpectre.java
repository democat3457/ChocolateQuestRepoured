...
public class RenderCQRSpectre extends RenderCQREntity<EntityCQRSpectre> {
	...
	public RenderCQRSpectre(RenderManager rendermanagerIn, ModelBase model, float shadowSize, String entityName, double widthScale, double heightScale) {
	...
	public void doRender(EntityCQRSpectre entity, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		this.mainModel.setModelAttributes(this.getMainModel());
