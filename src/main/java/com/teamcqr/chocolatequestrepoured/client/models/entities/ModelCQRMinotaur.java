...
public class ModelCQRMinotaur extends ModelCQRBiped {
	...
	public ModelCQRMinotaur(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn) {
		...
		this.tail2.addBox(0.0F, 0.0F, 0.0F, 2, 3, 2, modelSize);
		...
		this.tail1.addBox(0.0F, 0.0F, 0.0F, 1, 5, 1, modelSize);
		...
		this.hornL2.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, modelSize);
		...
		this.snout.addBox(0.0F, 0.0F, 0.0F, 4, 3, 1, modelSize);
		this.hornR2 = new ModelRenderer(this, 70, 9);
		this.hornR2.setRotationPoint(-7.7F, -8.2F, -3.0F);
		this.hornR2.addBox(0.0F, 0.0F, 0.0F, 1, 2, 1, modelSize);
		...
		this.hornL1.addBox(0.0F, 0.0F, 0.0F, 2, 3, 2, modelSize);
		...
		this.hornR1.addBox(0.0F, 0.0F, 0.0F, 2, 3, 2, modelSize);
