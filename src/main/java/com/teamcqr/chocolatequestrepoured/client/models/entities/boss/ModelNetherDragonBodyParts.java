...
public class ModelNetherDragonBodyParts {
	...
	public static class ModelNetherDragonBodyPartSkeletal extends ModelBase {
	    ...
	    public ModelNetherDragonBodyPartSkeletal() {
	        ...
	        this.setRotateAngle(ribRLowerBack, 0.0F, 0.0F, -1.1780972450961724F);
	        ...
	        this.setRotateAngle(ribRMiddleBack, 0.0F, 0.0F, -1.1780972450961724F);
	        ...
	        this.setRotateAngle(ribLUpper, 0.0F, 0.0F, -1.1780972450961724F);
	        ...
	        this.setRotateAngle(ribLMiddleBack, 0.0F, 0.0F, 1.1780972450961724F);
	        ...
	        this.setRotateAngle(RibRUpperBack, 0.0F, 0.0F, 1.1780972450961724F);
	        ...
	        this.setRotateAngle(ribLLower_1, 0.0F, 0.0F, 1.1780972450961724F);
	        ...
	        this.setRotateAngle(RibRUpper, 0.0F, 0.0F, 1.1780972450961724F);
	        ...
	        this.setRotateAngle(ribLUpperBack, 0.0F, 0.0F, -1.1780972450961724F);
