...
public class ModelCQRPollo extends ModelChicken {
	...
	public ModelCQRPollo() {
		...
		this.setRotateAngle(this.leftWing, 0.0F, 0.0F, 1.5707963267948966F);
		...
		this.setRotateAngle(this.rightWing, 0.0F, 0.0F, -1.5707963267948966F);
		...
		this.setRotateAngle(this.throat, 0.7853981633974483F, 0.0F, 0.0F);
