...
public class ModelNetherDragonHead extends ModelBase {
	...
	public ModelNetherDragonHead() {
		...
		this.setRotateAngle(this.Horn_Right_C, 0.0F, 0.0F, 0.7740535232594852F);
		...
		this.setRotateAngle(this.Horn_Left_C, 0.0F, 0.0F, 0.7740535232594852F);
		...
		this.setRotateAngle(this.Horn_Right_B, 0.0F, 0.0F, 0.8196066167365371F);
		...
		this.setRotateAngle(this.Horn_Left_A, -0.5009094953223726F, 0.3518583772020568F, -0.13439035240356337F);
		...
		this.setRotateAngle(this.Horn_Left_B, 0.0F, 0.0F, 0.8196066167365371F);
		...
		this.setRotateAngle(this.Head_Back, 0.0F, 1.5707963267948966F, 0.0F);
		...
		this.setRotateAngle(this.Horn_Right_A, 0.5009094953223726F, -0.3518583772020568F, -0.13439035240356337F);
